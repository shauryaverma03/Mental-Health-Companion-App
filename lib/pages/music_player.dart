...
import 'package:saathi/pages/song_player.dart';
...
class _MusicPlayerPageState extends State<MusicPlayerPage> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppTheme.standardAppBar('Music Therapy'),
        body: Container(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Container(
                  padding: const EdgeInsets.fromLTRB(AppTheme.spaceMd, AppTheme.spaceLg, AppTheme.spaceLg, AppTheme.spaceLg),
                  child: Text(
                    'Listen to \ntherapy music ..',
                              ...
                              children: [
                                  ...
                                  child: Image.network(
                                    ...
                                    errorBuilder: (context, error, stackTrace) {
                                      return Container(
                                        ...
                                        child: const Center(
                                          child: Icon(Icons.music_note, size: 50, color: AppTheme.primaryDark),
                                        ),
                                      );
                                    },
                                  ),
                                ...
                                Container(
                                  ...
                                  child: Text(
                                    ...
                                    style: AppTheme.heading3.copyWith(color: AppTheme.textOnPrimary),
