...
import { doc, getDoc, collection, getDocs, query, where, addDoc, deleteDoc, updateDoc, serverTimestamp } from 'firebase/firestore'; //
...
// Default welcome message (stable reference – declared at module scope)
...
export default function Chatbot() {
  ...
  const [, setTranscript] = useState(''); // live transcript
